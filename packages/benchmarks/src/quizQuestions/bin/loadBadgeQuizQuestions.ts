...
const assessmentNameToTagsMap = {
  ...
  'MongoDB Schema Design Patterns and Antipatterns': ['data modeling'],
  'MongoDB Advanced Schema Design Patterns and Antipatterns': ['data modeling'],
  'MongoDB Schema Design Optimization': ['data modeling'],
  'Building AI Agents with MongoDB': ['gen-ai'],
  'Building AI-Powered Search with MongoDB Vector Search': ['gen-ai'],
  'Building RAG Apps Using MongoDB': ['gen-ai'],
  'MongoDB Indexing Design Fundamentals': ['indexing'],
  'Monitoring MongoDB with Built-in Tools': ['monitoring tuning and automation'],
  'Optimizing MongoDB Performance with Tuning Tools': ['monitoring tuning and automation'],
  ...
  'Optimizing and Maintaining MongoDB Cluster Reliability': ['performance at scale'],
};
