...
const searchContentToolNotes = [
  `ALWAYS use the ${SEARCH_TOOL_NAME} tool at the start of the conversation. No exceptions!`,
  `For subsequent conversation messages, you can answer without using the ${SEARCH_TOOL_NAME} tool if the answer is already provided in the previous search results.`,
  ...
  `Only generate ONE ${SEARCH_TOOL_NAME} tool call unless there are clearly multiple distinct queries needed to answer the user query.`,
];
